...
const defaultDatabases = <DatabaseModel>[
  DatabaseModel(
    name: 'Northwind',
    description: 'Sales and products example',
  ...
  DatabaseModel(
    name: 'School',
    description: 'School management practice',
    tables: <String>['Students', 'Teachers', 'Subjects'],
  ),
];
