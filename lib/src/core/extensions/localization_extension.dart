...
extension LocalizationExtension on AppLocalizations {
  ...
  _translations = {
    ...
    AppLocalizationsKey.databaseCreationError: (l, args) =>
        l.databaseCreationError(args['databaseName']),
    ...
    AppLocalizationsKey.sqlExecutionError: (l, args) =>
        l.sqlExecutionError(args['error']),
    ...
    AppLocalizationsKey.failedToExecuteSql: (l, args) =>
        l.failedToExecuteSql(args['dbName'], args['error']),
    AppLocalizationsKey.failedToLoadSqlFiles: (l, args) =>
        l.failedToLoadSqlFiles(args['error']),
